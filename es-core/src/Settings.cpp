...
void Settings::setDefaults()
{
    ...
    mStringMap["global.retroachievements.token"] = {"", ""};
    mStringMap["global.retroachievements.apikey"] = {"", ""};
    mStringMap["global.netplay.nickname"] = {"", ""};
    mStringMap["global.netplay.username"] = {"", ""};
    ...
    mBoolMap["ThemeAnimations"] = {true, true};
    mBoolMap["ThemeVariantTriggers"] = {true, true};
    mBoolMap["RetroachievementsMenuitem"] = {true, true};
    mBoolMap["ShowCheevosIcon"] = {true, true};
    mBoolMap["CheevosCheckIndexesAtStart"] = {false, false};
    mBoolMap["global.retroachievements"] = {false, false};
    mBoolMap["global.retroachievements.hardcore"] = {false, false};
    mBoolMap["global.retroachievements.leaderboards"] = {false, false};
    mBoolMap["global.retroachievements.verbose"] = {false, false};
    mBoolMap["global.retroachievements.screenshot"] = {false, false};
    mBoolMap["global.retroachievements.encore"] = {false, false};
    mBoolMap["global.retroachievements.richpresence"] = {false, false};
    mBoolMap["global.retroachievements.unofficial"] = {false, false};
    mBoolMap["global.retroachievements.challenge_indicators"] = {false, false};
    mBoolMap["global.retroachievements.sound"] = {false, false};
    mBoolMap["global.netplay"] = {false, false};
...
bool Settings::hasString(const std::string& name) const
{
    return mStringMap.find(name) != mStringMap.cend();
}
