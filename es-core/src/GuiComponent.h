...
public:
    ...
    glm::vec2 getScreenOffset() const { return mScreenOffset; }
    void setScreenOffset(const glm::vec2& screenOffset) { mScreenOffset = screenOffset; }
    ...
    glm::vec2 getScaleOrigin() const { return mScaleOrigin; }
    // Sets the scale origin as a percentage of this image.
    // (e.g. (0, 0) is top left, (0.5, 0.5) is the center.)
    void setScaleOrigin(float originX, float originY)
    {
        mScaleOrigin = glm::vec2 {originX, originY};
    }
    void setScaleOrigin(glm::vec2 origin) { setScaleOrigin(origin.x, origin.y); }
    ...
    glm::vec2 getMinSize() const { return mMinSize; }
    void setMinSize(const glm::vec2& minSize) { mMinSize = minSize; setSize(mSize); }
    glm::vec2 getMaxSize() const { return mMaxSize; }
    void setMaxSize(const glm::vec2& maxSize) { mMaxSize = maxSize; setSize(mSize); }
...
protected:
    ...
    static inline unsigned int mMenuColorSelectorEnd {0xFFFFFFFF};
    static inline bool mMenuColorSelectorGradientHorizontal {true};
    static inline float mMenuSelectorOffsetY {0.0f};
    static inline float mMenuLineSpacing {1.0f};
    static inline unsigned int mMenuColorSeparators {0xC6C7C6FF};
    static inline unsigned int mMenuColorGroupBackground {0x00000000};
    ...
    static inline std::string mMenuFontPathTitle {""};
    static inline float mMenuFontSizeTitle {0.0f};
    static inline std::string mMenuFontPathPrimary {""};
    static inline float mMenuFontSizePrimary {0.0f};
    static inline std::string mMenuFontPathSecondary {""};
    static inline float mMenuFontSizeSecondary {0.0f};
    static inline unsigned int mMenuColorFooter {0x444444FF};
    static inline std::string mMenuFontPathFooter {""};
    static inline float mMenuFontSizeFooter {0.0f};

    static inline std::string mMenuImagePathBackground {""};    static inline std::string mMenuImagePathSwitchOn {":/graphics/on.svg"};
    static inline std::string mMenuImagePathSwitchOff {":/graphics/off.svg"};
    static inline std::string mMenuImagePathSliderKnob {":/graphics/slider_knob.svg"};
    static inline std::string mMenuImagePathButton {":/graphics/button.svg"};
    static inline std::string mMenuImagePathButtonFilled {":/graphics/button_filled.svg"};
    static inline std::string mMenuImagePathTextInput {":/graphics/textinput.svg"};
    static inline std::string mMenuImagePathTextInputFocused {":/graphics/textinput_focused.svg"};
    static inline glm::vec2 mMenuBackgroundCornerSize {30.0f, 30.0f};

    glm::vec3 mPosition;
    glm::vec2 mScreenOffset;
    glm::vec2 mOrigin;
    glm::vec2 mRotationOrigin;
    glm::vec2 mScaleOrigin;
    glm::vec2 mSize;
    glm::vec2 mMinSize;
    glm::vec2 mMaxSize;
