    ...
    , mDeleteRepeatTimer {0}
{
    ...
    const std::shared_ptr<Font> titleFont {
        Font::get(mMenuFontSizeTitle > 0.0f ? mMenuFontSizeTitle : FONT_SIZE_MEDIUM,
    ...
    if (mComplexMode) {
        mInfoString =
            std::make_shared<TextComponent>(infoString, secondaryFont, mMenuColorTitle, ALIGN_CENTER);
