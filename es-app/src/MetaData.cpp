...
namespace
{
    ...
    {"wheel",              MD_PATH,             "",                false,     "WHEEL",                       "ENTER PATH TO WHEEL",              true},
    {"logo",               MD_PATH,             "",                false,     "LOGO",                        "ENTER PATH TO LOGO",               true},
    {"fanart",             MD_PATH,             "",                false,     "FANART",                      "ENTER PATH TO FANART",             true},
    {"titleshot",          MD_PATH,             "",                false,     "TITLESHOT",                   "ENTER PATH TO TITLESHOT",          true},
    {"mix",                MD_PATH,             "",                false,     "MIX",                         "ENTER PATH TO MIX IMAGE",          true},
    ...
    {"cheevos_hash",       MD_STRING,           "",                false,     "RETROACHIEVEMENTS HASH",      "ENTER RETROACHIEVEMENTS HASH",     false},
    {"cheevos_id",         MD_INT,              "0",               false,     "RETROACHIEVEMENTS GAME ID",   "ENTER RETROACHIEVEMENTS GAME ID",  false},
...
void gettextMessageCatalogEntries()
{
    ...
    _p("metadata", "RETROACHIEVEMENTS HASH");
    _p("metadata", "ENTER RETROACHIEVEMENTS HASH");
    _p("metadata", "RETROACHIEVEMENTS GAME ID");
    _p("metadata", "ENTER RETROACHIEVEMENTS GAME ID");
