...
#define SDL_HINT_ENABLE_SCREEN_KEYBOARD "SDL_ENABLE_SCREEN_KEYBOARD"
    ...
    if (loadSystemsStatus == loadSystemsReturnCode::LOADING_OK &&
        Settings::getInstance()->getBool("global.retroachievements") &&
        Settings::getInstance()->getBool("CheevosCheckIndexesAtStart")) {
        ThreadedCheevosIndexer::start(false, nullptr, true);
    }
