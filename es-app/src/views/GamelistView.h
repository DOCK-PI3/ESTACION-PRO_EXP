...
private:
    ...
    std::vector<std::unique_ptr<RectangleComponent>> mRectangleComponents;
    std::vector<std::unique_ptr<ScreenShaderComponent>> mScreenShaderComponents;
    std::vector<std::unique_ptr<StackPanelComponent>> mStackPanelComponents;
    std::vector<std::unique_ptr<NinePatchComponent>> mNinePatchComponents;
    std::vector<std::unique_ptr<WebImageComponent>> mWebImageComponents;
    std::vector<std::unique_ptr<ContainerComponent>> mGenericContainerComponents;
    ...
    std::vector<std::unique_ptr<ControllerActivityComponent>> mControllerActivityComponents;
};
