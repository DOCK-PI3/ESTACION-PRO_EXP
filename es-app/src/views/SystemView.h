...
public:
    ...
    {
        if (mStaticBackgroundVideo != nullptr)
            mStaticBackgroundVideo->stopVideoPlayer();
    ...
    {
        if (mStaticBackgroundVideo != nullptr)
            mStaticBackgroundVideo->pauseVideoPlayer();
    ...
    {
        if (mStaticBackgroundVideo != nullptr)
            mStaticBackgroundVideo->muteVideoPlayer();
    ...
    {
        if (mStaticBackgroundVideo != nullptr)
            mStaticBackgroundVideo->resetVideoPlayerTimer();
...
private:
    ...
    struct SystemViewElements {
        ...
        std::vector<std::unique_ptr<ScreenShaderComponent>> screenShaderComponents;
        std::vector<std::unique_ptr<StackPanelComponent>> stackPanelComponents;
        std::vector<std::unique_ptr<NinePatchComponent>> ninePatchComponents;
        std::vector<std::unique_ptr<WebImageComponent>> webImageComponents;
        std::vector<std::unique_ptr<ContainerComponent>> genericContainerComponents;
        ...
        std::vector<std::unique_ptr<ControllerActivityComponent>> controllerActivityComponents;
    };
    ...
    std::unique_ptr<VideoFFmpegComponent> mStaticBackgroundVideo;
    ...
    int mSystemInfoDelayMs;
    bool mSystemInfoCountOnly;
    bool mPendingGameCountUpdate;
    int mPendingGameCountDelayMs;
};
