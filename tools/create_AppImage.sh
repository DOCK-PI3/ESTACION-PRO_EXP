...
ln -s usr/share/pixmaps/org.estacion_pro.frontend .
ln -s usr/share/applications/ESTACION-PRO .
ln -s estacion-pro.svg .DirIcon
cd usr/bin
ln -s ../share/estacion-pro/resources .
...
mv ESTACION-PRO-x86_64.AppImage ESTACION-PRO_x64.AppImage
echo -e "\nCreated AppImage ESTACION-PRO_x64.AppImage"
